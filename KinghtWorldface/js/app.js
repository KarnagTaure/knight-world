...
(function() {
    var timerUpdateDate = 0,
        ...
        arrMonth = ["Ene", "Feb", "Mar", "Abr", "May", "Jun", "Jul", "Ago", "Sep", "Oct", "Nov", "Dec"],
    	interval;
    ...
    function updateBattery() {
        ...
        elBatteryIcon.style.backgroundImage = "url('./images/color_status/battery_icon_" + statusColor + ".png')";      
    ...
    function bindEvents() {
        ...
        // Adds event listeners para cambiar la visualización del elemento secundario cuando se hace clic en el elemento de la batería.
 ...
 //Si hay permiso se obtiene la llamada para ver el total de pasos
    ...
    function mostarIconos(){
    	const imgBotasPath = 'images/Botas.png';
    	const imgEspadasPath = 'images/Espadas.png';
    	const imgCorazonPath = 'images/Corazon.png';
    	const imgPocionPath = 'images/Pocion.png';
    	const imgCalaveraPath= 'images/Calavera.png';
    	const imgVSPath= 'images/VS.png';
